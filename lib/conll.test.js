...
const treeJsonReplacedArray = {
    nodesJson: nodesJsonReplacedArray,
    groupsJson: groupsJsonReplacedArray,
};
test('replaceArrayOfTokens', () => {
    expect((0, conll_1.replaceArrayOfTokens)(treeJsonToBeReplaceArray, [3], ['a', 'red'])).toStrictEqual(treeJsonReplacedArray);
});
const nodesJsonToBeReplaceArrayDeprelBug = {
    '1': {
        ID: '1',
        FORM: 'bah',
        LEMMA: '_',
...
const groupsJsonToBeReplaceArrayDeprelBug = {};
const treeJsonToBeReplaceArrayDeprelBug = {
    nodesJson: nodesJsonToBeReplaceArrayDeprelBug,
    groupsJson: groupsJsonToBeReplaceArrayDeprelBug,
};
const nodesJsonReplacedArrayDeprelBug = {
    '1': {
        ID: '1',
        FORM: 'bah',
        LEMMA: '_',
...
const groupsJsonReplacedArrayDeprelBug = {};
const treeJsonReplacedArrayDeprelBug = {
    nodesJson: nodesJsonReplacedArrayDeprelBug,
    groupsJson: groupsJsonReplacedArrayDeprelBug,
};
test('replaceArrayOfTokensDeprelBug', () => {
    expect((0, conll_1.replaceArrayOfTokens)(treeJsonToBeReplaceArrayDeprelBug, [3], ['tutoie-', 'moi'])).toStrictEqual(treeJsonReplacedArrayDeprelBug);
});
