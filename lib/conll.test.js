...
const featuresJsonWithLowerAndUpperCase = { feat_key1: 'feat_value1', feat_key3: 'feat_value3', Feat_key2: 'feat_value2' };
const featureConllWithLowerAndUpperCase = 'feat_key1=feat_value1|Feat_key2=feat_value2|feat_key3=feat_value3';
const tokenConll = '1\tform\tlemma\tupos\txpos\tfeat_key=feat_value\t2\tdeprel\tdep_key=dep_value\tmisc_key=misc_value';
const tokenJson = {
    ID: '1',
    FORM: 'form',
    LEMMA: 'lemma',
...
const treeJson = { nodesJson: { "1": tokenJson }, groupsJson };
...
test('_encodeTabData', () => {
    expect((0, conll_1._encodeTabData)(3)).toBe('3');
    expect((0, conll_1._encodeTabData)('3')).toBe('3');
});
