...
export declare const emptyTreeJson: () => NodesJson;
...
export declare const _treeConllLinesToJson: (treeConllLines: string[]) => {
    nodesJson: NodesJson;
    groupsJson: GroupsJson;
};
...
export declare const _treeJsonToConll: (nodesJson: NodesJson, groupsJson: GroupsJson) => string;
...
export declare const replaceArrayOfTokens: (nodesJson: NodesJson, groupsJson: GroupsJson, oldTokensIndexes: number[], newTokensForms: string[]) => {
    newNodesJson: NodesJson;
    newGroupsJson: NodesJson;
};
